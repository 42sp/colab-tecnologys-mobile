	...
	return (
		<View className=" mt-6 gap-5 px-4 pb-4 ">
			<Card className=' gap-5'>
				<Card.Header>
					<Text className="text-xl font-inter-bold">Manage password</Text>
				</Card.Header>
			...
			<Card.Footer className='gap-5'>
				...
				<View className="flex flex-row items-center gap-5">
					<Image source={require('@/assets/fingerprint-icon.png')} className="w-12 h-12" />
			...
			<Card className="gap-5">
				<Card.Header>
					<Text className="text-xl font-inter-bold">Security tips</Text>
				</Card.Header>
				<Card.Body>
					<Text className="font-inter text-gray-500">{'\u2022'} Use a strong and unique password</Text>
					<Text className="font-inter text-gray-500">{'\u2022'} Never share your login details</Text>
					<Text className="font-inter text-gray-500">{'\u2022'} Enable biometric authentication</Text>
					<Text className="font-inter text-gray-500">{'\u2022'} Update your password regularly</Text>
				</Card.Body>
			</Card>
		</View>
	)
